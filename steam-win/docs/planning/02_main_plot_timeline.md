...
| EV-006 | 章末 3 → 章首 4 | 蜂巢戰線、六向幾何 | 同上 | 方格習慣 → **六角鄰接** | 六邊鄰接邏輯 | dossier `3` `nextHazard`；章 04 |
| EV-007 | 第 4 章（約 L25–L32） | 全章蜂巢、碎裂禁佈 | 同上 | 入門六角 → 高密度據點 | 敘事「走出新兵腦」 | dossier `4` |
| EV-008 | 章末 4 → 章首 5 | 斷線封鎖、方格廊道 | 同上 | 六角主軸 → **方格取捨** | 紅筆優先序敘事 | dossier `4` `nextHazard`；章 05 |
| EV-009 | 第 5 章（約 L33–L40） | 斷線封鎖（方格＋穿插六角） | 同上 | 多節點求救 → 佈陣歸檔 | 指揮倫理 | dossier `5` |
