...
description: 當使用者要調整 levels.json 的 timeLimit、coverageGoal、地圖大小、forbiddenCells，或要求某章關卡重平衡與 timeLimit 規則校正時使用。含第1章 1_3～1_8（playableCells+5）、第2章 2_1～2_8（playableCells+2）、第3～10章 3_1～10_8（timeLimit=playableCells）之固定公式（見 ref/formulas-and-heuristics.md）。
constraints:
...
- **第 3～10 章**：`3_1`～`10_8` 之 `timeLimit` = `playableCells`（1:1）：`ref/formulas-and-heuristics.md`
